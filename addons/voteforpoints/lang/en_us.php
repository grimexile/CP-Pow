...
return array(
	...
	"VoteDontExists"	=> "No existe el sitio de voto.",
	"UnableToVote"		=> "No se pudo votar por el server. Err no. %d",
	"AlreadyVoted"		=> "Ya votaste en este sitio.",
	"VoteNow"			=> "Disponible para votar",
	...
	"VoteNotice"		=> "Por favor ayudanos a crecer votando!",
	"CurrentCashPoints"	=> "Tienes los siguientes puntos de votación: <b>%s</b>",
	...
	"CashPointsLabel"	=> "Puntos de Votación",
);

...
<h2>Death Ranking</h2>
<h3>
	Top <?php echo number_format($limit=(int)Flux::config('DeathRankingLimit')) ?> Personajes con más muertes
...
<table class="horizontal-table">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="<strong>'.htmlspecialchars($chars[$i]->char_name).'</strong> es el '.$topRankType.' con más muertes!"' ?>>
...
<?php else: ?>
<p>No hay nadie. <a href="javascript:history.go(-1)">Regresar</a>.</p>
<?php endif ?>

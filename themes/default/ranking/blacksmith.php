...
<h3>
	Los Mejores <?php echo number_format($limit=(int)Flux::config('BlacksmithRankingLimit')) ?> Blacksmiths
...
<table class="horizontal-table">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="<strong>'.htmlspecialchars($chars[$i]->char_name).'</strong> es el mejor '.$topRankType.'!"' ?>>
...
<?php else: ?>
<p>No hay ningún personaje. <a href="javascript:history.go(-1)">Regresar</a>.</p>
<?php endif ?>

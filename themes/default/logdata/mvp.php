...
<h2 align="center">Historial de MvPs</h2>
<!--<h3 align="center">Busqueda</h3>-->
<form align="center" action="" method="get" class="search-form2">
	<?php echo $this->moduleActionFormInputs('ranking', 'mvp') ?>
	<p align="center">
        <label for="mvpdata">Filtrar por MvP:</label>
		...
		<input align="center" type="button" value="Resetear" onclick="reload()" />
	</p>
</form>
...
<?php if ($mvpdata): ?>
    <?php if($kills):?>
    <h3 align="center">Últimos <?php echo Flux::config('MVPRankingLimit') ?> MvPs Cazados</h3>
    <table class="horizontal-table" align="center">
    	<tr>
    		<th align="center"><?php echo Flux::message('MVPLogCharacterLabel') ?></th>
    		<th align="center"><?php echo Flux::message('MVPLogMonsterLabel') ?></th>
    		<th align="center">Cazados</th>
    	</tr>

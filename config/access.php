...
return array(
	...
	'modules' => array(
		...
		'ranking'	=> array(
			...
			//You have 4 option for this
				//AccountLevel::NOONE = even ( admin, member and guess ) can't see or view the menu.
				//AccountLevel::ANYONE = anyone can see this ( admin, member and guess )
				//AccountLevel::LOWGM = admin and low level gm can see and view the menu.
				//AccountLevel::ADMIN = only admin level can see or view the menu.
			'mvp_card_logs'       	=> AccountLevel::ANYONE,
			'mvp_drop_card_logs_v1'    => AccountLevel::ANYONE,
			'mvp_drop_card_logs_v2'    => AccountLevel::NOONE,
			'miniboss_drop_card_logs'    => AccountLevel::ANYONE,
		),
		'item'		=> array(
			'index'			=> AccountLevel::ANYONE,

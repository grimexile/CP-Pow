...
return array(
	'ServerAddress'				=> 'powroarchangels.com',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> 'portal/ESP',				// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'ponteunaaca',				// Installer/updater password.
	...
	'DefaultLanguage'			=> 'es_es',					// Specify the default control panel language (see FLUX_ROOT/lang/ directory for available languages.)
	'SiteTitle'					=> 'PowRO',					// This value is only used if the theme decides to use it.
	...
	'ResultsPerPage'			=> 100,						// The number of results to display in a paged set, per page.
	...
	'MailerFromAddress'			=> 'powroarchangels@gmail.com',		// The e-mail address displayed in the From field.
	'MailerFromName'			=> 'PowRO - Archangels',			// The name displayed with the From e-mail address.
	...
	'MailerSMTPUsername'		=> 'powroarchangels@gmail.com',					// When MailerUseSMTP is true: Authorized username for SMTP server.
	'MailerSMTPPassword'		=> 'utqbhgkaxolafnry',					// When MailerUseSMTP is true: Authorized SMTP server (for above user).
...
//			'login'			=> 'Logins',
			'mvp'			=> 'MvPs Derrotados',
			'mvp_drop_card_logs_v1'	=> 'Cartas MvP',
			'miniboss_drop_card_logs'	=> 'Cartas Mini-Boss',
//			'npc'			=> 'NPC',
//			'zeny'			=> 'Zeny'
		),
		'cplog'			=> array(
...
//			'blacksmith'	=> 'Blacksmiths',
			'homunculus'	=> 'Homunculos',
//			'mvp'			=> 'MVPs',
			'guild'			=> 'Guilds',
			'zeny'			=> 'Zeny',
//			//'mvp_card_logs'		=> 'Cartas MvP',
//			'mvp_drop_card_logs_v1'	=> 'Cartas MvP',
//			'miniboss_drop_card_logs'	=> 'Cartas Mini-Boss',
		),
		'item'			=> array(
